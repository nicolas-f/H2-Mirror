...
public class FunctionAlias extends SchemaObjectBase {
     ...
     */
    public static FunctionAlias newInstance(Schema schema, int id, String name, String javaClassMethod, boolean force, boolean noCache) {
     ...
     * @return the database object
     */
    public static FunctionAlias newInstanceFromSource(Schema schema, int id, String name, String source, boolean force, boolean noCache) {
        FunctionAlias alias = new FunctionAlias(schema, id, name);
        alias.source = source;
        alias.noCache = noCache;
        alias.init(force);
